...
import utils
from data_batcher import SliceBatchGenerator, MetaSliceBatchGenerator
from modules import ConvEncoder, DeconvDecoder, UNet, MetaUNet
...
class MetaUNetATLASModel(ATLASModel):
  ...
  def build_graph(self):
    ...
    metaunet = MetaUNet(input_shape=self.input_dims,
                ...
                scope_name="metaunet")
    self.logits_op = tf.squeeze(
      metaunet.build_graph(self.inputs_op), axis=3)
